let city;
let data_FormLs = JSON.parse(localStorage.getItem("bike_arnab"));
...
let imgCount = 0;
let imgArr = [
    JSON.parse(localStorage.getItem("bike_arnab")).image,
    JSON.parse(localStorage.getItem("bike_arnab")).img2,
    JSON.parse(localStorage.getItem("bike_arnab")).img3,
    JSON.parse(localStorage.getItem("bike_arnab")).img4,
];
console.log(imgArr);
